            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tambah Pemilik</li>
                    </ol>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 hstack gap-3 d-flex justify-content-between">
                            <h6>Tambah Pemilik</h6>
                        </div>
                        <div class="card-body">

                            <?= $this->session->flashdata('message') ?>

                            <form action="<?= base_url('super_admin/pemilik/tambah_proses') ?>" method="post" enctype="multipart/form-data">
                                <div class="row">

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="username" class="form-control-label">Username</label>
                                            <input class="form-control" id="username" name="username" type="text" value="<?= $input_data[0]; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="email" name="email" type="email" value="<?= $input_data[1]; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="nama" name="nama" type="text" value="<?= $input_data[4]; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="hstack gap-3">
                                                <input style="margin-bottom: 20px;" class="form-control" type="text" id="logo" name="logo" value="<?= $input_data[5] ?>" disabled>
                                    ...
                                    <div class="col-md-6" style="margin-top: -20px;">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="nama_pemilik" name="nama_pemilik" type="text" value="<?= $input_data[6]; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" style="margin-top: -20px;">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="alamat" name="alamat" type="text" value="<?= $input_data[7]; ?>" required>
                                        </div>
                                    </div>
