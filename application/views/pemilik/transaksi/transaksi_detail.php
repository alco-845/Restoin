                ...
                <div class="row">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <?php if ($itm->status == 'Proses') { ?>
                                                <?= anchor('pemilik/transaksi/ubah_order/' . $itm->id_detail, '<p class="mx-1 text-sm text-warning">Status: ' . $itm->status . '</p>') ?>
                                            <?php } else { ?>
                    ...
                    <div class="col-md-4 pt-3 pb-3">
                        <div class="card">
                            ...
                            <form action="<?= base_url('pemilik/transaksi/bayar') ?>" method="post">
                                ...
                                <div class="card-body border-0 pt-4 pt-lg-3 pb-2 pb-lg-3">
                                    ...
                                    <?php if ($trans->status != 'Sudah dibayar') { ?>
                                        ...
                                        <?php if ($trans->status == 'Sudah dibayar') { ?>
                                            <?= anchor('pemilik/transaksi/ubah_status/' . $trans->id_penjualan, '<p class="text-warning">Status: ' . $trans->status . '</p>') ?>
                                        <?php } else { ?>
