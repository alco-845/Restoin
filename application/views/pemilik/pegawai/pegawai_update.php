            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Ubah Pegawai</li>
                    </ol>
                </nav>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php foreach ($pegawai as $pgw) : ?>
                                ...
                                <form action="<?= base_url('pemilik/pegawai/ubah_proses') ?>" method="post">
                                    <div class="row">

                                    <input class="form-control" name="id_pegawai" type="hidden" value="<?= $pgw->id_pegawai; ?>">

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="nama" class="form-control-label">Nama</label>
                                                <input class="form-control" id="nama" name="nama" type="text" value="<?= $pgw->nama; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="username" name="username" type="text" value="<?= $pgw->username; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="hstack gap-3">
                                                    <input class="form-control" id="pass" aria-label="Password" name="pass" type="password" value="<?= $pgw->password; ?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="notelp" name="notelp" type="number" min="0" value="<?= $pgw->notelp; ?>" required>
                                            </div>
                                        </div>
