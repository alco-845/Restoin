                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 hstack gap-3 d-flex justify-content-between">
                            ...
                            <a type="button" class="btn btn-info ml-4" href="<?= base_url('pemilik/pegawai/tambah') ?>" role="button"><i class="fas fa-plus fa-sm"></i>&nbsp; Tambah</a>
                        </div>
                        <div class="card-body pt-2 pb-0">
                            <?= $this->session->flashdata('message') ?>

                            <form action="<?= base_url('pemilik/pegawai') ?>" method="post">
                            ...
                            <div class="table-responsive p-0 mt-4">
                                ...
                                ';
                                            ...
                                            foreach ($pegawai as $pgw) :
                                                if ($pgw->id_resto == $this->session->id_resto) {
                                                    if ($pgw->aktif == 1) {
                                                        $status = 'Aktif';
                                                        $warna = 'text-info';
                                                    } else {
                                                    ...
                                                    <tbody align="center">
                                                        <tr style="border-bottom: 1px solid lightgrey;">
                                                            ...
                                                            <td><?= anchor('pemilik/pegawai/ubah/' . $pgw->id_pegawai, '<div class="btn btn-success btn-m"><i class="fa fa-edit"></i></div>') ?></td>
                                                            <td onclick="javasript: return confirm('Anda yakin ingin menghapus data ini?')"><?= anchor('pemilik/pegawai/hapus/' . $pgw->id_pegawai, '<div class="btn btn-danger btn-m"><i class="fa fa-trash"></i></div>') ?></td>
                                                            <td><?= anchor('pemilik/pegawai/detail/' . $pgw->id_pegawai, '<div class="btn btn-warning btn-m"><i class="fa fa-info"></i></div>') ?></td>
                                                            <td><?= anchor('pemilik/pegawai/ubah_status/' . $pgw->id_pegawai, '<div class="' . $warna . '">' . $status . '</div>') ?></td>
