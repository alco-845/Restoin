                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('pemilik/menu/tambah_proses') ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="menu" name="menu" type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="harga" name="harga" type="number" min="0" required>
                                        </div>
                                    </div>
